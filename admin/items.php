            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Admin Panel Items</h4> </div>
			   ...
			   <div class="panel-body">
			    <?php include_once('plugins/additems.php'); ?>
                <form class="form-group text-center" method="post">
				<div class="form-inline">
				<input style="width:45%; margin-top: 2px;" class="form-control" name="market_hash_name" placeholder="Market hash name" />
				<input style="width:45%; margin-top: 2px" class="form-control" name="img" placeholder="Image" />
				</div>
				<div class="form-inline">
				<input style="width:45%; margin-top: 2px" class="form-control" name="botid" placeholder="Bot ID" />
				<input style="width:45%; margin-top: 2px" class="form-control" name="status" placeholder="Status - If you want items to be active set 1" />
				<input hidden style="width:45%;" name="trade" value="1" />
				</div>
			     <button style="width:45%; margin-top: 2px" class="btn btn-lg btn-success" type="submit" name="additems">Add Items</button>
				 <button style="width:45%; margin-top: 2px" class="btn btn-lg btn-danger">View Example</button>
				</form>
			   </div>
			   </div>
...
<table class="table">
  ...
  <tbody>
<?php include_once('plugins/items.php'); ?>
<?php
...
echo " <td><img src=\"http://steamcommunity-a.akamaihd.net/economy/image/$img/168fx140f)\" alt=\"$market_hash_name\" width=\"89px\" height=\"50px\"/></td>\n"; 
echo "      <td>$market_hash_name</td>\n"; 
echo "      <td>$botid</td>\n"; 
echo "      <td>$status</td>\n"; 
echo "    </tr>\n"; 
echo "\n";
